...
for datatype in ['Non_temporal','Temporal']:
    for sampling ,sampling_name in zip([SMOTE, RandomOverSampler, RandomUnderSampler, 'class_weight'], ['SMOTE', 'RandomOverSampler', 'RandomUnderSampler', 'class_weight']):
        ...
        for time_step in time_steps:
            ...
            for max_features in [2, 3,5,10]:
                for min_samples_leaf in [3, 5, 8]:
                    for min_samples_split in [8, 10, 12]:
                        for max_depth in [2,5,10]:
                            for n_estimators in [5,10,20, 30]:
                                ...
                                for train_index, test_index in skf.split(xdata, ydata):
                                    ...
                                    if sampling_name == 'class_weight':
                                        clf = RandomForestClassifier(bootstrap = True, class_weight='balanced', max_features= max_features, min_samples_leaf=min_samples_leaf, min_samples_split=min_samples_split, max_depth=max_depth, n_estimators=n_estimators)
                                        ...
                                        clf = RandomForestClassifier(bootstrap = True, max_features= max_features, min_samples_leaf=min_samples_leaf, min_samples_split=min_samples_split, max_depth=max_depth, n_estimators=n_estimators)
                                        clf.fit(xtrain, ytrain)
                                    ...
                                    print(f"Completed for 'datatype': {datatype}, 'sampling': {sampling_name}, 'time_step': {time_step}, 'max_features': {max_features}, 'min_samples_leaf': {min_samples_leaf}, 'min_samples_split': {min_samples_split}, 'max_depth': {max_depth}, 'n_estimators': {n_estimators}")

                                # Saving the results
                                final_results.append({'datatype': datatype,'sampling': sampling_name,'time_step': time_step, 'max_features': max_features, 'min_samples_leaf': min_samples_leaf, 'min_samples_split': min_samples_split, 'max_depth': max_depth, 'n_estimators': n_estimators,
...
results_incorrect.to_csv("rf_incorrect.csv", index=False)
...
results_correct.to_csv("rf_correct.csv", index=False)